 ...
 * @export
 */
export const TransactionsControllerApiAxiosParamCreator = function (
 ...
 * @export
 */
export const TransactionsControllerApiFp = function (
  configuration?: Configuration,
) {
  const localVarAxiosParamCreator =
    TransactionsControllerApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @param {number} id
    ...
    async getTransaction(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CoinsTransactionLogDTO>
    > {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.revertTransaction(id, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
 ...
 * @export
 */
export const TransactionsControllerApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
...
export class TransactionsControllerApi extends BaseAPI {
  ...
  public getTransaction(id: number, options?: AxiosRequestConfig) {
    return TransactionsControllerApiFp(this.configuration)
      .getTransaction(id, options)
