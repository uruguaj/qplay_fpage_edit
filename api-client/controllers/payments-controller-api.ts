 ...
 * @export
 */
export const PaymentsControllerApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    activateVIPCode: async (
      uuid: string,
      vIPCodeActivateRequest: VIPCodeActivateRequest,
      ...
      assertParamExists(
        "activateVIPCode",
        "vIPCodeActivateRequest",
        vIPCodeActivateRequest,
      );
      const localVarPath = `/payments/vipcode/{uuid}/activate`.replace(
        `{${"uuid"}}`,
     ...
     * @throws {RequiredError}
     */
    generateVIPCode: async (
      vIPCodeGenerateRequest: VIPCodeGenerateRequest,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'vIPCodeGenerateRequest' is not null or undefined
      assertParamExists(
        "generateVIPCode",
        "vIPCodeGenerateRequest",
        vIPCodeGenerateRequest,
      );
 ...
 * @export
 */
export const PaymentsControllerApiFp = function (
  configuration?: Configuration,
) {
  const localVarAxiosParamCreator =
    PaymentsControllerApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @param {string} uuid
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.activateVIPCode(
        uuid,
        vIPCodeActivateRequest,
        options,
      );
     ...
     * @throws {RequiredError}
     */
    async generateVIPCode(
      vIPCodeGenerateRequest: VIPCodeGenerateRequest,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<VIPCode>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.generateVIPCode(
        vIPCodeGenerateRequest,
        options,
      );
      return createRequestFunction(
 ...
 * @export
 */
export const PaymentsControllerApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    activateVIPCode(
      ...
      return localVarFp
        .activateVIPCode(uuid, vIPCodeActivateRequest, options)
    ...
    generateVIPCode(
      vIPCodeGenerateRequest: VIPCodeGenerateRequest,
      options?: any,
    ): AxiosPromise<VIPCode> {
      return localVarFp
        .generateVIPCode(vIPCodeGenerateRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class PaymentsControllerApi extends BaseAPI {
   ...
   */
  public activateVIPCode(
    uuid: string,
    vIPCodeActivateRequest: VIPCodeActivateRequest,
    options?: AxiosRequestConfig,
  ) {
    return PaymentsControllerApiFp(this.configuration)
      .activateVIPCode(uuid, vIPCodeActivateRequest, options)
