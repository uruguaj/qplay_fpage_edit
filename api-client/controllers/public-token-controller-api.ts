 ...
 * @export
 */
export const PublicTokenControllerApiAxiosParamCreator = function (
 ...
 * @export
 */
export const PublicTokenControllerApiFp = function (
  configuration?: Configuration,
) {
  const localVarAxiosParamCreator =
    PublicTokenControllerApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @param {LoginRequest} loginRequest
    ...
    async login(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<LoginResult>
    > {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.secureAccount(
        loginRequest,
        options,
      );
      return createRequestFunction(
 ...
 * @export
 */
export const PublicTokenControllerApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    secureAccount(
      ...
      return localVarFp
        .secureAccount(loginRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class PublicTokenControllerApi extends BaseAPI {
  ...
  public login(loginRequest: LoginRequest, options?: AxiosRequestConfig) {
    return PublicTokenControllerApiFp(this.configuration)
      .login(loginRequest, options)
