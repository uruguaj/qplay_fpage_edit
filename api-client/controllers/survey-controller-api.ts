 ...
 * @export
 */
export const SurveyControllerApiAxiosParamCreator = function (
...
export const SurveyControllerApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    SurveyControllerApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @param {*} [options] Override http request option.
    ...
    async getSurvey(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Survey>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getSurvey(
        options,
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.sendSurvey(
        surveyRequest,
        options,
      );
      return createRequestFunction(
 ...
 * @export
 */
export const SurveyControllerApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    sendSurvey(
      ...
      return localVarFp
        .sendSurvey(surveyRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class SurveyControllerApi extends BaseAPI {
  ...
  public getSurvey(options?: AxiosRequestConfig) {
    return SurveyControllerApiFp(this.configuration)
      .getSurvey(options)
