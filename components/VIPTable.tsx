...
const sections = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        default: "-",
        basic: '<span style="color: #ED7727; font-weight: bold;">BASIC</span>',
        medium:
  ...
  return (
    <div>
      <div style={{ display: "flex" }}>
        ...
        <button
          className={
            "btn-currency " + (currency === Currency.CZK ? "selected" : "")
          }
        ...
        <button
          className={
            "btn-currency " + (currency === Currency.EUR ? "selected" : "")
          }
