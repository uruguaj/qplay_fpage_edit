...
const LayoutDefault: NextPage<{ children: ReactChild | ReactChild[] }> = ({
  children,
}) => {
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-3 mt-4 inview">
              <h6 className="text-uppercase fw-bold">Užitečné odkazy</h6>
              <p>
            ...
            <div className="col-md-3 mt-4 inview">
              <h6 className="text-uppercase fw-bold">Pravidla a podmínky</h6>
              <p>
          ...
          <p className="text-center">
            © QPlay.cz. Všechna práva vyhrazena{" "}
            <span className="split">|</span>{" "}
            <span className="design">
              Designed by: <a href="https://skypad6000.eu">Skypad6000</a>
            </span>
          </p>
