  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Podrobný návod jak na našem serveru získat pozici YouTuber."
        />
      </Head>
      <Banner sm={true}>
      ...
      <section className="pagecontent">
        <div className="container">
          <p style={{ textAlign: "center" }}>
            ...
            vytvořením ticketu s typem &quot;Chci být YouTuber&quot;.
            O&nbsp;konečném udělení skupiny YouTuber rozhoduje vedení serveru.
          </p>
          <div
            style={{
              display: "flex",
          ...
          >
            <div>
              <h2>
                Podmínky pro prefix{" "}
                <span style={{ color: "red" }}>YouTuber</span>
              </h2>

              <p>- YouTube kanál musí mít více než 1 500 odběratelů.</p>

              <p>
                - Počet zhlédnutí na videích musí odpovídat počtu odběratelů.
              </p>
              ...
              <h3>
                Pravidla pro <span style={{ color: "red" }}>YouTubery</span> do
                2 000 odběratelů:
              </h3>
            ...
            <div>
              <h3>
                Pravidla pro <span style={{ color: "red" }}>YouTubery</span> nad
                20 000 odběratelů:
              </h3>
              ...
              <h3>
                Výhody <span style={{ color: "red" }}>YouTubera</span> na
                serveru:
              </h3>
              ...
              <p>
                4) Má možnost využít /nick (natáčení videí za skryté jméno).
              </p>
              ...
              <p>
                ...
                (lze o ni požádat v{" "}
                <a
                  href="https://info.qplay.cz/tickets/new"
                  target="_blank"
                  rel="noreferrer"
                >
                  ticketu
              ...
              <i>
                * Vyhrazujeme si právo na odebrání{" "}
                <span style={{ color: "red" }}>YouTubera</span> bez udání
                důvodu.
              </i>
            </div>
          </div>
          {/* <strong>YouTube kanál musí mít více než 1 500 odběratelů a jeho odběratelé musí být aktivní.</strong><br>
Odběratelé se musí přibližně shodovat s počtem zhlédnutí na videu.<br>
Na YouTube kanále se musí vyskytovat minimálně 2 videa z našeho serveru.<br>
<strong>YouTuber nesmí porušovat jakýmkoli způsobem</strong> <strong><a href="?page=pravidla">pravidla serveru QPlay.cz</a>.</strong>
<br><br>
<i>* Vyhrazujeme si právo na odebrání YouTubera bez udání důvodu.<br>
* V případě, že YouTubera osloví samotné Vedení serveru, podmínky pro přijetí budou pozměněny.<br></i> */}
        </div>
      </section>
    </div>
  );
