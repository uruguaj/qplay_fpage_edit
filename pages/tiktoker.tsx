  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Podrobný návod jak na našem serveru získat pozici TikToker."
        />
      </Head>
      <Banner sm={true}>
      ...
      <section className="pagecontent">
        <div className="container">
          <p style={{ textAlign: "center" }}>
            ...
            vytvořením ticketu s typem &quot;Chci být TikToker&quot;.
            O&nbsp;konečném udělení skupiny TikToker rozhoduje vedení serveru.
          </p>
          <br />
          <div
            style={{
          ...
          >
            <div>
              <h2>
                Podmínky pro prefix{" "}
                <span style={{ color: "#FF1493" }}>TikToker</span>
              </h2>

              <p>- TikTok kanál musí mít více než 500 sledujících.</p>

              <p>
                - Na každém videu z našeho serveru musí být alespoň 1 000
                zhlédnutí.
              </p>

              <p>
                - Na TikTok kanále se musí vyskytovat alespoň 3 videa z našeho
                serveru.
              </p>

              <p>
                - TikToker se musí snažit aktivně vydávat každý měsíc alespoň 2
                videa z našeho serveru.
              </p>
              ...
              <br />
              <h2>
                Výhody <span style={{ color: "#FF1493" }}>TikTokera</span> na
                serveru:
              </h2>
              ...
              <i>
                * Vyhrazujeme si právo na odebrání{" "}
                <span style={{ color: "#FF1493" }}>TikTokera</span> bez udání
                důvodu.
              </i>
            </div>
          </div>
