...
const Home: NextPage<HomeProps> = ({ changelogNews }) => {
  ...
  function ChangeLogNewsRender() {
    const news = changelogNews.slice(0, 3).map((element) => {
      return <ChangelogCard key={element["id"]} element={element} />;
    });
            ...
            <div>
              <div className="d-flex">
                <h2>
                  IP:{" "}
                  <span
                    data-text="Klikni pro zkopírování!"
                    className="hint"
                    onClick={() => {
              ...
              <p>
                Online hráči: {playersShow}/{playersMaxShow}
              </p>
            </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-7 d-flex">
              <div className="content">
                <h1>
                  O <span className="colored">QPLAY.CZ</span>
                </h1>
                <p>
                  Minecraft server QPlay.cz, který patří mezi největší servery v
                  Česku a Slovensku, byl založen v roce 2015 a nabízí spoustu
                  různých miniher. Za své dlouhodobé působení na česko-slovenské
                  scéně se pyšní pokročilým technickým nastavením. Server
                  vytvořil i svou vlastní minihru MiniAnnihilation. Dále si
                  můžete na serveru zahrát minihry, které jsou známé především
                  ze zahraničí - BedWars, SkyWars, 1vs1 a další. Přijďte si užít
                  hru Minecraft na serveru QPlay.
                </p>
                <div className="stats">
                  <div className="row">
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-7">
              <h1>Discord</h1>
              <p>
                Připoj se na náš discord a propoj si účet pro získání zajímavých
                výhod
              </p>
              <ul>
                <li>Máte přístup do místnosti #general 🎮</li>
                <li>
                  Otevře se vám místnost #pomoc-mezi-hráči, ve které můžete
                  požádat o pomoc druhých hráčů, nebo naopak druhým hráčům
                  můžete pomoct vy 👥
                </li>
                <li>
                  Máte přístup do mnoha dalších text channelů pod sekcí Komunita
                  | QPlay a Komunita | Ostatní ✌️
                </li>
                <li>Máte k dispozici několik volných voice místností 🗣️</li>
                <li>
                  Máte možnost se zúčastňovat herních akcí! Pokud bude probíhat
                  akce, zjistíte to v místnosti oznámení 🎲
                </li>
                <li>
                  Pokud na serveru vlastníte jakékoliv VIP, tak automaticky
                  obdržíte roli &quot;VIP&quot;. Navíc obdržíte přístup do VIP
                  chatu #vip-chat 💎
                </li>
              </ul>
            ...
            <div className="col-lg-4 mb-4">
              <div className="card">
                ...
                <div className="card-body">
                  <div className="content">
                    <p>
                      Natěž si suroviny, ze kterých si vytvoříš své brnění a
                      nástroje. Ovládni střed mapy, abys získal i diamantové
                      věci. Poté znič nexus ostatním týmům.
                    </p>
            ...
            <div className="col-lg-4 mb-4">
              <div className="card">
                ...
                <div className="card-body">
                  <div className="content">
                    <p>
                      Natěž si suroviny, postav si své obydlí, objevuj svět,
                      vydělávej peníze a relaxuj!
                    </p>
                    <h4>Seznam serverů</h4>
                    <ul>
                      <li>Survival</li>
                    ...
                    <ul>
                      <li>
                        <a href="https://mapa-survival.qplay.cz/">
                          mapa-survival.qplay.cz
                        </a>
                      </li>
                    </ul>
                  </div>
            ...
            <div className="col-lg-4 mb-4">
              <div className="card">
                ...
                <div className="card-body">
                  <div className="content">
                    <p>
                      Posbírej z truhel na ostrovech ty nejlepší věci pro boj a
                      zabij všechny nepřátele.
                    </p>
                    <h4>Seznam serverů</h4>
                    <ul>
                      <li>SkyWars Solo</li>
            ...
            <div className="col-lg-4 mb-4">
              <div className="card">
                ...
                <div className="card-body">
                  <div className="content">
                    <p>
                      Seskákej jako první, nasbírej co nejvíce bodů, vyzbroj se
                      a ve finálním boji zůstaň jako poslední naživu.
                    </p>
                    <h4>Seznam serverů</h4>
                    <ul>
                      <li>GetDown</li>
            ...
            <div className="col-lg-4 mb-4">
              <div className="card">
                ...
                <div className="card-body">
                  <div className="content">
                    <p>
                      Natěž si ve volné přírodě co nejlepší suroviny a zabij
                      všechny nepřátele.
                    </p>
                    <h4>Seznam serverů</h4>
                    <ul>
            ...
            <div className="col-lg-4 mb-4">
              <div className="card">
                ...
                <div className="card-body">
                  <div className="content">
                    <p>
                      Nasbírej na svém ostrově co nejvíce ingotů (bronze, iron,
                      gold), zakup si věci u vesničana a znič postel ostatním
                      týmům.
                    </p>
                    <h4>Seznam serverů</h4>
                    <ul>
