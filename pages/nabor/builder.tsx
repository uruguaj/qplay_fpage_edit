  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Podrobný návod jak na našem serveru získat pozici Builder."
        />
      </Head>
      <Banner sm={true}>
        ...
        <div className="container">
          <h1 style={{ textAlign: "center", fontSize: "xx-large" }}>
            <span style={{ color: "#000000" }}>
              <b>Nábor na Buildera</b>
            </span>
          </h1>
          <h4>
            <span style={{ color: "#000000" }}>Jak se stát Builderem?</span>
          </h4>
          <span style={{ color: "#000000" }}>
            ...
            vytvořit nový ticket s typem &quot;Žádost o Buildera&quot;, kde vám
            bude poskytnuto více informací.
            <br />
            <br />
          </span>
          <h4>
            <span style={{ color: "#000000" }}>Výhody Buildera</span>
          </h4>
          <li>
            <span style={{ color: "#000000" }}>
          ...
          <br />
          <h4>
            <span style={{ color: "#000000" }}>Odměna za práci Buildera</span>
          </h4>
          <li>
            <span style={{ color: "#000000" }}>
