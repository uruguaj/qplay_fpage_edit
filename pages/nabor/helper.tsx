  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Podrobný návod jak na našem serveru získat pozici Helper."
        />
      </Head>
      <Banner sm={true}>
        ...
        <div className="container">
          <h1 style={{ textAlign: "center", fontSize: "xx-large" }}>
            <span style={{ color: "#000000" }}>
              <b>Nábor na Helpera</b>
            </span>
          </h1>
          <h4>
            <span style={{ color: "#000000" }}>Jak se stát Helperem?</span>
          </h4>
          <span style={{ color: "#000000" }}>
            V této chvíli je <b>nábor</b> na pozici Helpera <b>uzavřen</b>.
            <br />V případě otevřeného náboru všechny hráče informujeme na
            našich <b>sociálních sítích a na této stránce</b>.
          </span>
          <p></p>
          <h4>
            <span style={{ color: "#000000" }}>Výhody Helpera</span>
          </h4>
          <li>
            <span style={{ color: "#000000" }}>
          ...
          <br />
          <h4>
            <span style={{ color: "#000000" }}>Odměna za práci Helpera</span>
          </h4>
          <li>
            <span style={{ color: "#000000" }}>
