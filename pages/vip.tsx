  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Zakoupení VIP účtu na našem serveru."
        />
      </Head>
      <Banner sm={true}>
    ...
    <center>
          ...
          <h3 style={{ textAlign: "center" }}>
            <span style={{ fontWeight: "bold" }}>
              Zakoupením VIP skrz{" "}
              <a
                href="https://store.qplay.cz/category/328613"
                target="_blank"
                rel="noreferrer"
              >
                store.qplay.cz
              </a>{" "}
              lze obdržet bonusové Mystery Crates NAVÍC!
            </span>
          </h3>
          ...
          <p>
            *Crate Shards je měna, kterou vlastní pouze hráč s LEGEND VIP.
            Získává se místo Coinů hraním miniher. Na Lobby v Crate Factory si
            lze následně Crate Shards proměnit na normální crates (BASIC,
            MYSTERY, LEGEND) a v sezónách i na například Christmas, Valentine,
            Halloween crate.
          </p>
          ...
          <div>
            ...
            <p>
              Od 4.12.2017 přecházíme na nový systém aktivace VIP účtů.
              Zakoupíte si tzv. KÓD K AKTIVOVÁNÍ VIP ÚČTU - pomocí sms, PayPalu
              či PSC a ve zpětné sms obdržíte 8 místný kód ve tvaru XXXX-XXXX.
              Po jeho obdržení doporučujeme navštívit stránku
              ...
              <b>
                {" "}
                dárkovou poukázku - ideální dárek pro Vaše kamarády či rodinu.
              </b>
            </p>
            ...
            <div>
              <b>Postup:</b>
              <br />
              1) Zakoupíte si KÓD - standardním způsobem - SMS, PSC, PayPal
              <br />
              2) Po obdržení kódu (XXXX-XXXX) přejdete na stránku
              <a href="https://kod.qplay.cz"> https://kod.qplay.cz</a>, kam kód
              zadáte
              <br />
              3) Zvolíte možnost aktivace
              <br />
              4) Počkáte cca 5 minut a Vaše VIP výhody by měly být aktivní!
              <br />
            </div>
            <br />
            <div>
            ...
            <br />
            <p>
              Při současně aktivovaných více druhů VIP zároveň se nejprve
              aktivuje to nejlepší a poté se postupně aktivují sestupně od
              nejlepších po nejhorší. Při zakoupení více VIP stejného typu se
              doby expirace prodlužují.
            </p>
          </div>
          ...
          <div className="href-offset">
            ...
            <p>
              ...
              zaplacení Vám přijde sms (v případě platby pomocí sms) nebo email
              (v případě platby pomocí PSC nebo PayPal) s kódem. Tento kód
              zadejte na stránce{" "}
              <a href="https://kod.qplay.cz" target="_blank" rel="noreferrer">
                https://kod.qplay.cz
              </a>{" "}
              a zvolte možnost vygenerovat dárkový poukaz. Tento vygenerovaný
              dárkový poukaz je možné vytisknout a je platný ihned po zaplacení.
              <br />
              <br />V případě jakýchkoliv dotazů se na nás neváhejte obrátit –
              jak se dozvíte v sekci Kontakt.
            </p>

            <div>
              Další informace k VIP platbě, <em>reklamace</em> atd. můžete řešit
              pomocí ticketu na
              <a href="https://info.qplay.cz">
                <strong> info.qplay.cz</strong>
              </a>
          ...
          <div style={{ marginTop: "2em" }}>
            ...
            <ol style={{ listStyle: "decimal", listStylePosition: "inside" }}>
              ...
              <li>
                Pokud VIP i po hodině od odeslání SMS nemáte, zkontrolujte si
          ...
          <div>
            ...
            <ul>
              <li>
                ...
                po hodině nemáte VIP výhody aktivní, neváhejte se na nás
                obrátit.
              </li>
              <li>
                VIP neslouží jako obrana vůči banu = v případě porušení
                Obchodních podmínek, Podmínek použití služeb QPlay.cz či
                pravidel herního serveru, může Vám být zakázán přístup na
                server.
              </li>
              ...
              <li>
                Negarantujeme, že po dobu trvání VIP výhod bude umožněn přístup
                na server. V případě, že herní server QPlay.cz nebude dále
              ...
              <li>
                Vyhrazujeme si právo na okamžitou úpravu VIP výhod bez
                upozornění.
              </li>
            </ul>
          </div>
