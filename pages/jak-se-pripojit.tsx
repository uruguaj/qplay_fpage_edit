  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Podrobný návod jak se zaregistovat a připojit na náš server."
        />
      </Head>
      <Banner sm={true}>
      ...
      <section className="pagecontent">
        <div className="container">
          ...
          <strong>/login vaseheslo</strong> <br />
          <br />
          <strong>BONUS</strong> - Pokud vlastníte originální účet, můžete
          využít našeho návodu na ověření:{" "}
          <strong>
            <Link
              href="/navod/prihlaseni-bez-hesla"
              className="text-decoration-underline"
              passHref
            >
              KLIKNI ZDE
